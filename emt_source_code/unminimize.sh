...
echo ""
echo "*** If you got a message saying the system is minimized, you can leave it"
echo "*** minimized with CTL-C during the next 20 second sleep, or by waiting"
echo "*** for the prompt and answering 'N'."
echo ""
